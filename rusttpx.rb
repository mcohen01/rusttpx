class Rusttpx < Formula
  ...
  homepage "https://github.com/yourusername/rusttpx"
  version "0.1.0"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/yourusername/rusttpx/releases/download/v0.1.0/rusttpx-aarch64-apple-darwin"
      sha256 "PLACEHOLDER_SHA256_FOR_ARM64"
    else
      url "https://github.com/yourusername/rusttpx/releases/download/v0.1.0/rusttpx-x86_64-apple-darwin"
      sha256 "PLACEHOLDER_SHA256_FOR_X86_64"
    end
  end

  on_linux do
    url "https://github.com/yourusername/rusttpx/releases/download/v0.1.0/rusttpx-x86_64-unknown-linux-gnu"
